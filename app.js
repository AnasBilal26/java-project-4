...
document.write(
  "<br> The multiplication of " + num3 + " and " + num4 + " is: " + multiply
);
...
document.write(
  "<br> The divide of " + num5 + " and " + num6 + " is: " + divide
);
...
const exchangeRateUSD = 104.8;
const exchangeRateSAR = 28;

const totalInPakistaniRupees =
  usDollars * exchangeRateUSD + saudiRiyals * exchangeRateSAR;

document.write(
  "<br><h1>Currency in PKR</h1>Total amount in Pakistani Rupees:",
  totalInPakistaniRupees
);
